...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
  ...
  if(!empty($email1) && !empty($pass1) && !is_numeric($email1) )
  {
    $query = "insert into login (email1, pass1) values ('$email1', '$pass1')";
...
<html lang="en">
  ...
  <?php include 'db.php' ?>    <!-- oneeeeeeeee  -->  
  <body>
    <div class="main">
      <div class="ff">
        <div class="logo">
